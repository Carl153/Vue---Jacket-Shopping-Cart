...
Vue.component('product', {
  ...
  data() { // This part of code displays all the information for the products on the website.
    return {
      ...
      inventory: 0,
      onSale: true,
      details: ["100% Real duck and goose feathers!", "Multiple colours available!", "Kids sizes available!"],
      variants: [
        {
          variantId: 2234,
          variantPrice: 149.99,
          variantColor: 'green',
          variantImage: 'images/green-jacket.jpeg',
          variantQuantity: 3,
        },
        {
          variantId: 2235,
          variantPrice: 174.99,
          variantColor: 'blue',
          variantImage: 'images/blue-jacket.jpg',
          variantQuantity: 12,
        },
        {
          variantId: 2236,
          variantPrice: 149.99,
          variantColor: 'yellow',
          variantImage: 'images/yellow-jacket.jpg',
          variantQuantity: 1,
        },
        {
          variantId: 2237,
          variantPrice: 195.99,
          variantColor: 'black',
          variantImage: 'images/black-jacket.jpg',
          variantQuantity: 8,
        },
        {
          variantId: 2238,
          variantPrice: 129.99,
          variantColor: 'orange',
          variantImage: 'images/orange-jacket.jpg',
          variantQuantity: 11,
        },
      ],
      classes: {
